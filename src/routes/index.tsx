          ...
          <Reveal>
            <div className="relative overflow-hidden rounded-[1.75rem] card-ivory p-6 text-center sm:p-10">
              ...
              <p className="text-foreground/90 mt-4 text-lg leading-loose sm:text-xl">
                நிகழும் மங்களகரமான பராபவ வருடம் ஆவணி மாதம் 27-ம் தேதி (13-09-2026) ஞாயிற்றுக்கிழமை காலை 10.30 மணிக்கு மேல் 11.30 மணிக்குள் சுபயோக சுபதினத்தில், செல்வி <span className="font-bold text-maroon">அம்ரிதாவின்</span> மஞ்சள் நீராட்டு விழா, பெரியோர்களின் ஆசியோடு பந்தநல்லூரில் உள்ள எங்கள் இல்லத்தில் இனிதே நடைபெற இருப்பதால், தாங்கள் தங்கள் சுற்றமும் நட்பும் சூழ வருகை தந்து விழாவைச் சிறப்பிக்க அன்புடன் அழைக்கின்றோம்.
              </p>
              <img
                src={lamp}
                alt=""
